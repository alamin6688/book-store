    ...
    return (
        <div>
            ...
            <div className="listed-books">
                {bookList.length > 0 ? (
                    bookList.map(book => (
                        <div key={book.bookId} className='border flex flex-col lg:flex-row my-10 gap-5 p-5 rounded-xl items-center'>
                            <img src={book.image} className='w-[26%] rounded-xl mx-auto lg:mx-0' />
